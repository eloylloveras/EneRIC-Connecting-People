...
import random
prompt_base = """
Eres un modelo especializado en correlacionar valores numericos con niveles de potencia en vatios (W). 
Se te proporcionara un numero de entrada, y tu tarea es devolver unicamente el valor de potencia correspondiente 
segun las siguientes reglas:

1. Si el numero de entrada esta entre 0 y 10, la potencia es 10W.
2. Si el numero de entrada esta entre 11 y 30, la potencia es 50W.
3. Si el numero de entrada esta entre 31 y 72, la potencia es 100W.
4. Si el numero de entrada esta entre 73 y 140, la potencia es 150W.
5. Si el numero de entrada es mayor a 140, la potencia es 200W.

Reglas de respuesta:
- Devuelve unicamente el valor de potencia correspondiente en formato "XW".
- No expliques el razonamiento ni anadas ningun otro texto en la respuesta.

Ejemplos de entrada y salida:
Entrada: 0  ? Salida: "10W"
Entrada: 5  ? Salida: "10W"
Entrada: 10 ? Salida: "10W"
Entrada: 15 ? Salida: "50W"
Entrada: 22 ? Salida: "50W"
Entrada: 30 ? Salida: "100W"
Entrada: 50 ? Salida: "100W"
Entrada: 72 ? Salida: "100W"
Entrada: 90 ? Salida: "150W"
Entrada: 110 ? Salida: "150W"
Entrada: 140 ? Salida: "150W"
Entrada: 150 ? Salida: "200W"
Entrada: 185 ? Salida: "200W"
Entrada: 196 ? Salida: "200W"
"""
        ...
        if kpm_report_style in [1,2]:
            ...
            for ue_id, ue_meas_data in meas_data["ueMeasData"].items():
                ...
                for metric_name, value in ue_meas_data["measData"].items():
                    ...
                    # INSERT HERE
                    answer = send_data(value)
                    decrementar()
                    print("---Metric: {}, Value: {}".format(metric_name, value))
                    if contador == 0:
                        contador = 14
                        print("=================================")
                        print(f"Changing power concurrency to: {answer}")
                        print("=================================")
